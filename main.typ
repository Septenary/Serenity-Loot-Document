...
= Trial Promotion
Trial Raiders must have 4x raid nights (2x Tuesday + 2x Thursday, or 4x Thursday) of 40m \<Serenity\> raids to become eligible for promotion to Core Raider. Being benched counts as attendance. Attendence must be consecutive (unless excused by an officer) and demonstrate contribution to our team's success.
